...
export const whatsappService = {
   ...
   * Get all chats
   */
  getChats: async (sessionId?: string): Promise<WhatsAppResponse> => {
    try {
      const url = sessionId 
   ...
   */
  getMessages: async (sessionId: string, chatId: string): Promise<WhatsAppResponse> => {
    try {
   ...
   * Send a message
   */
  sendMessage: async (data: MessageData): Promise<WhatsAppResponse> => {
    try {
   ...
   * Get all sessions
   */
  getSessions: async (): Promise<WhatsAppResponse> => {
    try {
   ...
   */
  syncSessions: async (): Promise<WhatsAppResponse> => {
    try {
